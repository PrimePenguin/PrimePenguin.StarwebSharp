...
namespace StarwebSharp.Filters
{
    public class OrderFilter : Parameterizable
    {
        ...
        /// <summary>
        ///     Set to true if you want to fetch orders that has not been completed yet. An order is ”completed” when the payment
        ...
        /// <summary>
        ///     A filter query to filter the fetched orders by. Will search in fields such as: customer/company name, order items
        ///     sku and description, etc
        /// </summary>
        ...
        ///     Available values : orderId, createdAt, modifiedAt, customer, paymentMethodName, shippingMethodName, totalAmount,
        ///     status, read
        /// </summary>
        [JsonProperty("sortBy")]
        ...
        ///     Example: ?include=items (to include order items) or ?include=items,externalServices (to include order items as well
        ///     as external ids).
