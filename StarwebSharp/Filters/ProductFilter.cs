...
namespace StarwebSharp.Filters
{
    public class ProductFilter : Parameterizable
    {
        ...
        ///  <summary>
        /// Use this to only fetch products that has been created since a certain time. The time should be formatted using ISO-8601 (url encoded)
        /// </summary>
        [JsonProperty("createdSince")]
        public string CreatedSince { get; set; }

        /// <summary>
        /// Use this to only fetch products that has been modified since a certain time. The time should be formatted using ISO-8601 (url encoded)
        /// </summary>
