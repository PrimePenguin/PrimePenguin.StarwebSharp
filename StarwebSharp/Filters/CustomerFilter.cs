...
namespace StarwebSharp.Filters
{
    public class CustomerFilter : Parameterizable
    {
        ...
        /// <summary>
        ///     Use this to only fetch customers that has been created since a certain time. The time should be formatted using
        ...
        /// <summary>
        ///     Use this to only fetch customers that has been modified since a certain time. The time should be formatted using
        ///     ISO-8601 (url encoded)
        /// </summary>
        ...
        ///     Example: ?include=tags (to include customer tags); ?include=tags,addresses (to include both customer tags and
        ///     addresses).
