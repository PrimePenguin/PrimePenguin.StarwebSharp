...
namespace StarwebSharp.Services.ProductBundledProductPrice
{
    public class ProductBundledProductPriceService : StarwebService
    {
        ...
        public ProductBundledProductPriceService(string myStarwebUrl, string shopAccessToken) : base(myStarwebUrl, shopAccessToken) { }
        ...
        public virtual async Task<ProductBundleProductPriceModel> UpdateAsync(int productId,int bundledProductId, int pricelistId,
