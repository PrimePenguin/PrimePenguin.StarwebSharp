...
namespace StarwebSharp.Services.ProductVariant
{
    ...
    public class ProductVariantService : StarwebService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual async Task<IEnumerable<ProductVariantModel>> ListAsync(int productId,
            ProductVariantFilter filter = null)
        {
        ...
        public virtual async Task<ProductVariantModel> CreateAsync(int productId,
            ProductVariantCreateUpdateModel variant)
        {
            var req = PrepareRequest($"products/{productId}/variants");
        ...
        public virtual async Task<ProductVariantModel> UpdateAsync(int productId, int variantId,
            ProductVariantCreateUpdateModel variant)
        {
            var req = PrepareRequest($"products/{productId}/variants/{variantId}");
            var body = variant.ToDictionary();
        ...
        /// <param name="variant">The <see cref="ProductVariantCreateUpdateModel" /> to update.</param>
        /// <returns>The updated <see cref="ProductVariantModel" />.</returns>
        public virtual async Task<ProductVariantModel> PatchAsync(int productId, int variantId,
            ProductVariantCreateUpdateModel variant)
        {
            var req = PrepareRequest($"products/{productId}/variants/{variantId}");
            var body = variant.ToDictionary();
