...
namespace StarwebSharp.Services.ProductVariantAttribute
{
    public class ProductVariantAttributeService : StarwebService
    {
        ...
        public ProductVariantAttributeService(string myStarwebUrl, string shopAccessToken) : base(myStarwebUrl,
            shopAccessToken)
        {
        }
        ...
        public virtual async Task<ProductVariantAttributeModel> UpdateAsync(int attributeId,
            ProductVariantAttributeModel model)
        {
