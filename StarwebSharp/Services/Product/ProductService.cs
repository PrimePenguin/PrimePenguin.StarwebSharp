...
namespace StarwebSharp.Services.Product
{
    ...
    public class ProductService : StarwebService
    {
        ...
        /// <param name="include">
        ///     If you want to include child data in the result. Example: ?include=variants (to include product
        ///     variants); ?include=variants,languages (to include both product variants and languages). Available includes:
        ///     primaryVariant, primaryVariant.prices, mediaFiles, languages, vatRates, categories, unit, metaData. NOTE! Only one
        ///     variant is included in result for performance reason. To fetch all variants, instead use /products/x/variants
        ///     (unnecessary if hasSeveralVariants is false)
        /// </param>
