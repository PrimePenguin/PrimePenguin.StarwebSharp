...
namespace StarwebSharp.Entities
{
    public class OrderUpdateModel
    {
        ...
        /// <summary>Set this to false to prevent sending email to customer on changes to statusId and new orders</summary>
        ...
        [JsonProperty("hasComment", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// <summary>A collection of order items</summary>
        [JsonProperty("items", NullValueHandling = NullValueHandling.Ignore)]
        public ICollection<OrderItemModel> Items { get; set; } =
            new Collection<OrderItemModel>();

        [JsonProperty("addresses", NullValueHandling = NullValueHandling.Ignore)]
        public OrderAddressModel Addresses { get; set; } = new OrderAddressModel();
    }
}