...
namespace StarwebSharp.Infrastructure
{
    ...
    {
        public StarwebRateLimitException() : base() { }

        public StarwebRateLimitException(string message): base(message) { }

        public StarwebRateLimitException(HttpStatusCode httpStatusCode, string error, string jsonError) : base(httpStatusCode, error, jsonError) { }
    }
}
